...
function naturalSort(val1: number|string, val2: number|string){
    //nulls first
    if(val2 != null && val1 == null){ return -1; }
    if(val1 != null && val2 == null){ return 1; }

    //then raw NaNs
    if(typeof val1 === "number" && isNaN(val1)){ return -1; }
    if(typeof val2 === "number" && isNaN(val2)){ return 1; }

    //numbers and numbery strings group together
    let numVal1 = +val1;
    let numVal2 = +val2;
    if(numVal1 < numVal2){ return -1; }
    if(numVal1 > numVal2){ return 1; }
    ...
    if(isNaN(numVal2) && !isNaN(numVal1)){ return -1; }
    if(isNaN(numVal1) && !isNaN(numVal2)){ return 1; }

    //finally, "smart" string sorting
    let stringVal1 = ""+val1;
    let stringVal2 = ""+val2;
    if(stringVal1 === stringVal2){ return 0; }
    ...
    while(stringDig1?.length && stringDig2?.length){
...
function getSort(sorters: any, attr: string){
    if(sorters != null){
